                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select campo-obrigatorio" name="categoria_equipamento">
                                ...
                                <?php foreach ([
                                    'Monitorização','Suporte de vida','Terapia','Diagnóstico',
                                    'Laboratório','Esterilização','Reabilitação','Imagiologia',
                                    'Ventilação','Outro'
                                ] as $cat): ?>
...
const sugestoes = {
    'ventilador': { marca: 'Dräger', fabricante: 'Dräger', categoria: 'Ventilação', criticidade: 'Suporte de vida', estado: 'operacional' },
    'monitor': { marca: 'Philips', fabricante: 'Philips', categoria: 'Monitorização', criticidade: 'Alta', estado: 'operacional' },
    'desfibrilhador': { marca: 'Zoll', fabricante: 'Zoll', categoria: 'Suporte de vida', criticidade: 'Suporte de vida', estado: 'operacional' },
    'bomba': { marca: 'B. Braun', fabricante: 'B. Braun', categoria: 'Terapia', criticidade: 'Media', estado: 'operacional' },
    'ecógrafo': { marca: 'GE Healthcare', fabricante: 'GE Healthcare', categoria: 'Diagnóstico', criticidade: 'Alta', estado: 'operacional' },
    'autoclave': { marca: 'Getinge', fabricante: 'Getinge', categoria: 'Esterilização', criticidade: 'Media', estado: 'operacional' },
    'oxímetro': { marca: 'Nonin', fabricante: 'Nonin', categoria: 'Monitorização', criticidade: 'Alta', estado: 'operacional' },
    'eletrocardiógrafo': { marca: 'Schiller', fabricante: 'Schiller', categoria: 'Diagnóstico', criticidade: 'Media', estado: 'operacional' },
    'microscópio': { marca: 'Zeiss', fabricante: 'Zeiss', categoria: 'Diagnóstico', criticidade: 'Alta', estado: 'operacional' },
    'incubadora': { marca: 'Dräger', fabricante: 'Dräger', categoria: 'Outro', criticidade: 'Suporte de vida', estado: 'operacional' },
    'laser': { marca: 'Lumenis', fabricante: 'Lumenis', categoria: 'Terapia', criticidade: 'Alta', estado: 'operacional' },
    'endoscópio': { marca: 'Olympus', fabricante: 'Olympus', categoria: 'Diagnóstico', criticidade: 'Alta', estado: 'operacional' },
    'pacemaker': { marca: 'Medtronic', fabricante: 'Medtronic', categoria: 'Suporte de vida', criticidade: 'Suporte de vida', estado: 'operacional' },
    'hemodialisador': { marca: 'Fresenius', fabricante: 'Fresenius', categoria: 'Terapia', criticidade: 'Suporte de vida', estado: 'operacional' },
    'balança': { marca: 'SECA', fabricante: 'SECA', categoria: 'Diagnóstico', criticidade: 'Baixa', estado: 'operacional' },
    'tensiómetro': { marca: 'Omron', fabricante: 'Omron', categoria: 'Monitorização', criticidade: 'Media', estado: 'operacional' },
    'cama': { marca: 'Hill-Rom', fabricante: 'Hill-Rom', categoria: 'Outro', criticidade: 'Baixa', estado: 'operacional' },
};
