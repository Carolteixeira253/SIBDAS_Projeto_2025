        ...
        try {
            ...
            $stmt = $ligacao->prepare("
                INSERT INTO Fornecedor
                    (nomeFornecedor, nif, tipoFornecedor, contactoTelefonico, enderecoEmail, morada)
                VALUES
                    (:nome, :nif, :tipo, :telefone, :email, :morada)
            ");
            $stmt->execute([
                ':nome'     => $nome,
                ':nif'      => $nif,
            ...
            $erro_sistema = "Não foi possível guardar o fornecedor. Verifique a sua ligação à internet.";
        }
    }
}
?>
        ...
        <div class="d-flex justify-content-between align-items-start mb-4">
            <div>
                <h1 class="fw-bold h2 mb-1 text-dark">
                    <i class="fa-solid fa-truck text-primary me-2"></i>Novo Fornecedor
                </h1>
                <p class="text-muted small mb-0">
                    Registe um novo fornecedor ou entidade parceira.
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="nome_fornecedor"
                               placeholder="Ex: Siemens Healthineers Portugal, Lda."
                               value="<?= htmlspecialchars($_POST['nome_fornecedor'] ?? '') ?>" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">NIF <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="nif_fornecedor"
                               maxlength="9" placeholder="123456789"
                               value="<?= htmlspecialchars($_POST['nif_fornecedor'] ?? '') ?>" required>
                    </div>
                    <div class="col-md-3">
                        ...
                        <select class="form-select" name="tipo_fornecedor">
                            ...
                            foreach ($tipos as $v => $l):
                                $sel = (($_POST['tipo_fornecedor'] ?? '') === $v) ? 'selected' : '';
                            ?>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="morada_fornecedor"
                               placeholder="Ex: Rua da Saúde, 123, Lisboa"
