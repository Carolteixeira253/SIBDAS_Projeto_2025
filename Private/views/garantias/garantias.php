...
try {
    ...
    $resultados = $ligacao->query("SELECT * FROM Garantia")->fetchAll(PDO::FETCH_OBJ);
    $erro = '';
                ...
                <table id="tabela-garantias" class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <?php elseif (count($resultados) == 0) : ?>
                            <tr><td colspan="6" class="text-center text-muted">Não existem garantias registadas.</td></tr>
                        <?php else : ?>
